...
/* ═══════════════════════════════════════════════════════════
   BEITON & Co — Notary Website Demo v2
...
/* ══ קונפיג לסוכן 1 (תקשורת) — שירותים נלווים ואפשרויות קבלה ══
   לא מוצג במחשבון. הסוכן משתמש בזה בשיחות עם לקוחות.
   מחירי השליחות הם מחירי BEITON & Co — לא מוסדרים בתקנות. */
...
const T = {
  he: {
    ...
    useCases: { tag: "USE CASES", h2: "שירותי נוטריון נפוצים", subtitle: "חיפוש לפי הצורך שלך", allFilter: "הכל", items: [
      ...
      { name: "אישור חיים", tag: "תצהיר" }, { name: "אישור חיים לפנסיה מחו״ל", tag: "תצהיר" }, { name: "תצהיר רווקות", tag: "תצהיר" },
      { name: "תרגום תעודת לידה", tag: "תרגום נוטריוני" }, { name: "תרגום דיפלומה", tag: "תרגום נוטריוני" }, { name: "תרגום רישיון נהיגה", tag: "תרגום נוטריוני" }, { name: "תרגום תעודת נישואין", tag: "תרגום נוטריוני" }, { name: "תרגום תעודת גירושין", tag: "תרגום נוטריוני" }, { name: "חבילת מסמכים לאזרחות פורטוגזית", tag: "תרגום נוטריוני" }, { name: "תרגום דיפלומה אוקראינית", tag: "תרגום נוטריוני" }, { name: "נוטריון לגרמנית", tag: "תרגום נוטריוני" },
      { name: "העתק נאמן למקור", tag: "אימות" },
      { name: "אפוסטיל משרד החוץ", tag: "אפוסטיל משרד החוץ" },
    ] },
  ...
  en: {
    ...
    useCases: { tag: "USE CASES", h2: "Common Notary Use Cases", subtitle: "Search by your need", allFilter: "All", items: [
      ...
      { name: "Certificate of Life", tag: "Affidavit" }, { name: "Life Certificate for Pension", tag: "Affidavit" }, { name: "Single Status Affidavit", tag: "Affidavit" },
      { name: "Birth Certificate Translation", tag: "Translation" }, { name: "Diploma Translation", tag: "Translation" }, { name: "Driver's License Translation", tag: "Translation" }, { name: "Marriage Certificate Translation", tag: "Translation" }, { name: "Divorce Certificate Translation", tag: "Translation" }, { name: "Portuguese Citizenship Package", tag: "Translation" }, { name: "Ukrainian Diploma Translation", tag: "Translation" }, { name: "German Language Notary", tag: "Translation" },
      { name: "Certified True Copy", tag: "Authentication" },
      { name: "Apostille (Foreign Ministry)", tag: "Apostille" },
    ] },
  ...
  ru: {
    ...
    useCases: { tag: "USE CASES", h2: "Популярные нотариальные услуги", subtitle: "Ищите по потребности", allFilter: "Все", items: [
      ...
      { name: "Свидетельство о жизни", tag: "Аффидевит" }, { name: "Свидетельство для пенсии", tag: "Аффидевит" }, { name: "Аффидевит о статусе", tag: "Аффидевит" },
      { name: "Перевод свидетельства о рождении", tag: "Перевод" }, { name: "Перевод диплома", tag: "Перевод" }, { name: "Перевод прав", tag: "Перевод" }, { name: "Перевод свидетельства о браке", tag: "Перевод" }, { name: "Перевод свидетельства о разводе", tag: "Перевод" }, { name: "Пакет для Португалии", tag: "Перевод" }, { name: "Перевод украинского диплома", tag: "Перевод" },
      { name: "Заверенная копия", tag: "Заверение" }, { name: "Апостиль (МИД)", tag: "Апостиль" },
    ] },
  ...
  ar: {
    ...
    useCases: { tag: "USE CASES", h2: "خدمات كاتب عدل شائعة", subtitle: "ابحث/ي حسب احتياجك", allFilter: "الكل", items: [
      ...
      { name: "شهادة حياة", tag: "إفادة" }, { name: "شهادة حياة للتقاعد", tag: "إفادة" }, { name: "إفادة عدم زواج", tag: "إفادة" },
      { name: "ترجمة شهادة ميلاد", tag: "ترجمة" }, { name: "ترجمة شهادة جامعية", tag: "ترجمة" }, { name: "ترجمة رخصة قيادة", tag: "ترجمة" }, { name: "ترجمة عقد زواج", tag: "ترجمة" }, { name: "ترجمة وثيقة طلاق", tag: "ترجمة" }, { name: "حزمة جنسية برتغالية", tag: "ترجمة" },
      { name: "نسخة طبق الأصل", tag: "توثيق" }, { name: "أبوستيل (وزارة الخارجية)", tag: "أبوستيل" },
    ] },
  ...
  fr: {
    ...
    useCases: { tag: "USE CASES", h2: "Services notariaux courants", subtitle: "Cherchez selon votre besoin", allFilter: "Tout", items: [
      ...
      { name: "Certificat de vie", tag: "Affidavit" }, { name: "Certificat retraite", tag: "Affidavit" }, { name: "Celibat", tag: "Affidavit" },
      { name: "Acte de naissance", tag: "Traduction" }, { name: "Diplome", tag: "Traduction" }, { name: "Permis de conduire", tag: "Traduction" }, { name: "Acte de mariage", tag: "Traduction" }, { name: "Acte de divorce", tag: "Traduction" }, { name: "Citoyennete portugaise", tag: "Traduction" },
      { name: "Copie certifiee", tag: "Authentification" }, { name: "Apostille", tag: "Apostille" },
    ] },
  ...
  es: {
    ...
    useCases: { tag: "USE CASES", h2: "Servicios notariales comunes", subtitle: "Busca segun tu necesidad", allFilter: "Todo", items: [
      ...
      { name: "Certificado de vida", tag: "Declaracion" }, { name: "Certificado para pension", tag: "Declaracion" }, { name: "Solteria", tag: "Declaracion" },
      { name: "Partida de nacimiento", tag: "Traduccion" }, { name: "Diploma", tag: "Traduccion" }, { name: "Licencia de conducir", tag: "Traduccion" }, { name: "Acta de matrimonio", tag: "Traduccion" }, { name: "Acta de divorcio", tag: "Traduccion" }, { name: "Ciudadania portuguesa", tag: "Traduccion" },
      { name: "Copia certificada", tag: "Autenticacion" }, { name: "Apostilla", tag: "Apostilla" },
    ] },
...
export default function App() {
  ...
  const S = { // shared styles
    tag: { fontSize: 11, fontWeight: 500, letterSpacing: 4, textTransform: "uppercase", color: "#999", marginBottom: 10, textAlign: "center" },
    h2: { fontSize: "clamp(26px,4vw,38px)", fontWeight: 300, textAlign: "center", marginBottom: 6 },
    sub: { fontSize: 14, fontWeight: 300, color: "#6B6B6B", textAlign: "center", marginBottom: 36, maxWidth: 520, margin: "0 auto 36px", lineHeight: 1.7 },
    lbl: { display: "block", fontSize: 11, fontWeight: 500, color: "#999", marginBottom: 6 },
    inp: { width: "100%", padding: "10px 14px", borderRadius: 8, border: "1px solid #E8E6E1", fontSize: 13, fontFamily: cfg.font, background: "#FAFAF8", marginBottom: 18, direction: "ltr" },
  };
  ...
  return (
    <div dir={cfg.dir} style={{ fontFamily: cfg.font, color: "#1A1A1A", background: "#fff", minHeight: "100vh", lineHeight: 1.7, WebkitFontSmoothing: "antialiased" }}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=DM+Sans:wght@300;400;500&family=Noto+Sans+Hebrew:wght@300;400;500&family=Noto+Sans+Arabic:wght@300;400;500&display=swap');
      ...
      <nav style={{ position: "sticky", top: 0, zIndex: 100, background: "rgba(255,255,255,.96)", backdropFilter: "blur(12px)", borderBottom: "1px solid #E8E6E1" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 56 }}>
          ...
          <div className="dn" style={{ display: "flex", alignItems: "center", gap: 22 }}>
            {Object.entries(t.nav).map(([k, v]) => <a key={k} className="nl" onClick={() => go(k)} style={{ fontSize: 12, color: "#1A1A1A", textDecoration: "none", transition: "opacity .2s" }}>{v}</a>)}
        ...
        {menu && <div style={{ background: "#fff", borderTop: "1px solid #E8E6E1", padding: "10px 24px" }}>
          {Object.entries(t.nav).map(([k, v]) => <a key={k} onClick={() => go(k)} style={{ display: "block", padding: "9px 0", fontSize: 14, color: "#1A1A1A", textDecoration: "none", borderBottom: "1px solid #F5F4F1" }}>{v}</a>)}
      ...
      <section id="home" style={{ padding: "72px 24px 52px", maxWidth: 760, margin: "0 auto", textAlign: "center" }}>
        ...
        <div className="fu fd2" style={{ maxWidth: 500, margin: "0 auto", background: "#FAFAF8", borderRadius: 14, border: "1px solid #E8E6E1", overflow: "hidden" }}>
          ...
          <div style={{ padding: "10px 14px", borderTop: "1px solid #E8E6E1", background: "#fff", display: "flex", gap: 8, alignItems: "center" }}>
            ...
            <input readOnly placeholder={t.hero.chatPlaceholder} style={{ flex: 1, border: "none", background: "transparent", fontSize: 12, fontFamily: cfg.font, color: "#6B6B6B", outline: "none", direction: cfg.dir, padding: "7px 0" }} />
      ...
      <section id="usecases" style={{ padding: "64px 24px", maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 5, justifyContent: "center", marginBottom: 24 }}>
          {[t.useCases.allFilter, ...[...new Set(t.useCases.items.map(u => u.tag))]].map(tag => {
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(240px,1fr))", gap: 8 }}>
          {t.useCases.items.filter(u => ucF==="all"||u.tag===ucF).map((uc, i) => (
      ...
      <section id="pricing" style={{ background: "#F5F4F1", padding: "64px 24px" }}>
        <div style={{ maxWidth: 560, margin: "0 auto" }}>
          ...
          <div style={{ background: "#fff", borderRadius: 14, padding: 28, border: "1px solid #E8E6E1" }}>
            ...
            <select value={selSvc} onChange={e => { setSelSvc(e.target.value); setPages(1); setSigs(1); setDocs(1); setCopies(1); setWords(100); }} style={{ ...S.inp, appearance: "none", direction: cfg.dir }}>
              <option value="">—</option>
          ...
          {t.blog.items && t.blog.items.length > 0 ? (
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(260px,1fr))", gap: 16 }}>
              {t.blog.items.map((post, i) => (
                <article key={i} className="sc" style={{ background: "#FAFAF8", borderRadius: 12, padding: 24, border: "1px solid #E8E6E1", transition: "all .3s", cursor: "pointer" }}>
