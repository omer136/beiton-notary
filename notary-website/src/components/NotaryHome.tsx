...
const T: Record<string, any> = {
  he: {
    ...
    hero: { h1: "שירותי נוטריון בישראל", chatGreeting: "היי! אני נועה מצוות הנוטריון. איך אפשר לעזור?", chatPlaceholder: "איך נוכל לעזור? (תרגום, אימות חתימה, צוואה...)", chatSend: "שלח" },
  ...
  en: {
    ...
    hero: { h1: "Notary Services in Israel", chatGreeting: "Hi! I'm Noa from the notary team. How can I help?", chatPlaceholder: "How can we help? (translation, signature, will...)", chatSend: "Send" },
  ...
  ru: {
    ...
    hero: { h1: "Нотариальные услуги в Израиле", chatGreeting: "Привет! Я Ноа из нотариальной команды. Чем помочь?", chatPlaceholder: "Как мы можем помочь? (перевод, подпись, завещание...)", chatSend: "Отправить" },
  ...
  ar: {
    ...
    hero: { h1: "خدمات كاتب العدل في إسرائيل", chatGreeting: "مرحباً! أنا نوعة من فريق كاتب العدل. كيف أساعدك؟", chatPlaceholder: "كيف يمكننا مساعدتكم؟ (ترجمة، توثيق، وصية...)", chatSend: "إرسال" },
  ...
  fr: {
    ...
    hero: { h1: "Services Notariaux en Israel", chatGreeting: "Bonjour! Je suis Noa. Comment puis-je aider?", chatPlaceholder: "Comment pouvons-nous aider? (traduction, signature...)", chatSend: "Envoyer" },
  ...
  es: {
    ...
    hero: { h1: "Servicios Notariales en Israel", chatGreeting: "Hola! Soy Noa del equipo notarial. Como puedo ayudar?", chatPlaceholder: "Como podemos ayudarle? (traduccion, firma, testamento...)", chatSend: "Enviar" },
