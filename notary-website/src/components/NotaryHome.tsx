...
const T: Record<string, any> = {
  he: {
    ...
    hero: { h1: "שירותי נוטריון בישראל", chatGreeting: "היי! אני נועה מצוות הנוטריון. איך אפשר לעזור?", chatPlaceholder: "למשל: צריך תרגום תעודת לידה לאנגלית עם אפוסטיל", chatSend: "שלח" },
  ...
  en: {
    ...
    hero: { h1: "Notary Services in Israel", chatGreeting: "Hi! I'm Noa from the notary team. How can I help?", chatPlaceholder: "e.g.: I need a birth certificate translated with apostille", chatSend: "Send" },
  ...
  ru: {
    ...
    hero: { h1: "Нотариальные услуги в Израиле", chatGreeting: "Привет! Я Ноа из нотариальной команды. Чем помочь?", chatPlaceholder: "напр.: нужен перевод свидетельства о рождении с апостилем", chatSend: "Отправить" },
  ...
  ar: {
    ...
    hero: { h1: "خدمات كاتب العدل في إسرائيل", chatGreeting: "مرحباً! أنا نوعة من فريق كاتب العدل. كيف أساعدك؟", chatPlaceholder: "مثال: أحتاج ترجمة شهادة ميلاد للإنجليزية مع أبوستيل", chatSend: "إرسال" },
  ...
  fr: {
    ...
    hero: { h1: "Services Notariaux en Israel", chatGreeting: "Bonjour! Je suis Noa. Comment puis-je aider?", chatPlaceholder: "ex: traduction d'acte de naissance avec apostille", chatSend: "Envoyer" },
  ...
  es: {
    ...
    hero: { h1: "Servicios Notariales en Israel", chatGreeting: "Hola! Soy Noa del equipo notarial. Como puedo ayudar?", chatPlaceholder: "ej: traducir certificado de nacimiento con apostilla", chatSend: "Enviar" },
