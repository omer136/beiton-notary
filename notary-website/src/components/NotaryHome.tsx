...
const T: Record<string, any> = {
  he: {
    ...
    hero: { h1: "שירותי נוטריון בישראל", chatGreeting: "היי! אני נועה מצוות הנוטריון. איך אפשר לעזור?", chatPlaceholder: "למשל: צריך תרגום תעודת נישואין לאנגלית עם אפוסטיל", chatSend: "שלח" },
  ...
  en: {
    ...
    hero: { h1: "Notary Services in Israel", chatGreeting: "Hi! I'm Noa from the notary team. How can I help?", chatPlaceholder: "e.g.: I need a marriage certificate translated with apostille", chatSend: "Send" },
  ...
  ru: {
    ...
    hero: { h1: "Нотариальные услуги в Израиле", chatGreeting: "Привет! Я Ноа из нотариальной команды. Чем помочь?", chatPlaceholder: "напр.: нужен перевод свидетельства о браке с апостилем", chatSend: "Отправить" },
  ...
  ar: {
    ...
    hero: { h1: "خدمات كاتب العدل في إسرائيل", chatGreeting: "مرحباً! أنا نوعة من فريق كاتب العدل. كيف أساعدك؟", chatPlaceholder: "مثال: أحتاج ترجمة شهادة زواج للإنجليزية مع أبوستيل", chatSend: "إرسال" },
  ...
  fr: {
    ...
    hero: { h1: "Services Notariaux en Israel", chatGreeting: "Bonjour! Je suis Noa. Comment puis-je aider?", chatPlaceholder: "ex: traduction d'acte de mariage avec apostille", chatSend: "Envoyer" },
  ...
  es: {
    ...
    hero: { h1: "Servicios Notariales en Israel", chatGreeting: "Hola! Soy Noa del equipo notarial. Como puedo ayudar?", chatPlaceholder: "ej: traducir certificado de matrimonio con apostilla", chatSend: "Enviar" },
...
export default function NotaryHome() {
  ...
  const [cookie, setCookie] = useState(false); // start hidden, show after checking localStorage
  ...
  return (
    <div dir={cfg.dir} style={{ fontFamily: cfg.font, color: "#1A1A1A", background: "#fff", minHeight: "100vh", lineHeight: 1.7, WebkitFontSmoothing: "antialiased" }}>
      ...
      {cookie && <>
        {/* Dim overlay */}
        <div style={{ position: "fixed", inset: 0, zIndex: 199, background: "rgba(0,0,0,.4)", backdropFilter: "blur(2px)" }} />
        {/* Banner */}
        <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 200, background: "#fff", borderTop: "1px solid #E8E6E1", padding: "20px 24px", boxShadow: "0 -4px 24px rgba(0,0,0,.12)" }}>
