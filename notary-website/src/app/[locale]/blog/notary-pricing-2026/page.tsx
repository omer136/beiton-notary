          ...
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              },
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: '289 ₪ + מע"מ עד 100 מילים, 228 ₪ לכל 100 מילים נוספות עד 1,000, ו-113 ₪ מעבר ל-1,000.',
                },
              },
              {
                "@type": "Question",
          ...
          >
            {[
              ...
              },
              {
                ...
                price:
                  "289 ₪ עד 100 מילים, 228 ₪ לכל 100 מילים נוספות עד 1,000, 113 ₪ מעבר ל-1,000",
              },
              {
                service: "אישור העתק",
                price: "88 ₪ לעמוד ראשון, 29 ₪ לכל עמוד נוסף",
              },
              {
                service: "הסכם ממון",
                price: "513 ₪, 88 ₪ לכל עותק נוסף",
              },
              {
                service: "צוואה נוטריונית",
                price:
                  "337 ₪ לחותם ראשון, 169 ₪ לכל חותם נוסף",
              },
              { service: "אישור חיים", price: "197 ₪" },
              {
                service: "תצהיר נוטריוני",
                price:
                  "197 ₪ למצהיר ראשון, 77 ₪ לכל מצהיר נוסף",
              },
            ].map((row, i) => (
              <div
                key={i}
          ...
          <div style={{ marginBottom: 32 }}>
            {[
              ...
              },
              {
                ...
                a: '289 ₪ + מע"מ עד 100 מילים, 228 ₪ לכל 100 מילים נוספות עד 1,000, ו-113 ₪ מעבר ל-1,000.',
              },
              {
